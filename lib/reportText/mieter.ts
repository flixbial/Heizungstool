...
export function mieterReportText(input: ReportTextInput): ReportText {
  ...
  if (tone === "positive") {
    return {
      ...
      intro:
        `Über ${years} Jahre ergibt sich ein Kostenvorteil bei den laufenden Ausgaben (Energie + CO₂-Anteil).`,
      bullets: [
